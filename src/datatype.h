...
#define UR(C)    C->ur
#define LB(C)    C->lb
#define OF(C)    C->offset
#define CT(C)    C->center
#define ORT(C)   C->orientation
#define WH(C)    C->W_H
#define O_WH(C)  C->ori_W_H
#define M(C)     C->module
#define P(C)     C->pad
#define PS(C)    C->pins
#define PLB(C)   C->pin_lb
#define PRU(C)   C->pin_ur
